            ...
            <div className="flex justify-between">
                <div>
                    <Link href="/listados/stockproductos/nuevoloteproducto">
                        <a className="bg-blue-800 py-2 px-2 mt-3 mr-2 text-white rounded text-sm hover:bg-gray-800 mb-3 uppercase font-bold w-full lg:w-auto text-center">Nuevo Lote</a>
                    </Link>
                    {!vistaPorLotes ? 
                        <button onClick={() => handleOpenCloseLotes()}>
                                <a className="bg-blue-800 py-2 px-2 mt-3 mr-1 inline-block text-white rounded text-sm hover:bg-gray-800 mb-3 uppercase font-bold w-full lg:w-auto text-center">Ver Totales</a>
                        </button>
                    :   <button onClick={() => handleOpenCloseLotes()}>
