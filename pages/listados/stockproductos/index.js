  ...
  return (
    <Layout>
      ...
      <div className="flex justify-between">
        <div>
          <Link
            className="bg-blue-800 py-2 px-5 mt-3 mr-2 inline-block text-white rounded text-sm hover:bg-gray-800 mb-3 uppercase font-bold w-full lg:w-auto text-center"
            href="/listados/stockproductos/nuevoloteproducto"
          >
            Nuevo Lote
          </Link>
          {!vistaPorLotes ? (
      ...
      {vistaPorLotes ? (
        <TableTotal registros={registrosTotal} rol={rol} filtros={filtros} />
      ) : (
