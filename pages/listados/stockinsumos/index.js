...
const StockInsumos = () => {
    ...
    if(loading || loadingSumados) return (
        <Layout>
            ...
            <div className="flex justify-between">
                <div>
                    <Link href="/listados/stockinsumos/nuevoloteinsumo">
                        <a className="bg-blue-800 mr-2 py-2 px-5 mt-3 inline-block text-white rounded text-sm hover:bg-gray-800 mb-3 uppercase font-bold w-full lg:w-auto text-center">Nuevo Lote</a>
                    </Link>
                    {!vistaPorLotes ? 
                        <button onClick={() => handleOpenCloseLotes()}>
                                <a className="bg-blue-800 py-2 px-5 mt-3 mr-1 inline-block text-white rounded text-sm hover:bg-gray-800 mb-3 uppercase font-bold w-full lg:w-auto text-center">Ver por Lotes</a>
                        </button>
                    :   <button onClick={() => handleOpenCloseLotes()}>
                            <a className="bg-blue-800 py-2 px-5 mt-3 mr-1 inline-block text-white rounded text-sm hover:bg-gray-800 mb-3 uppercase font-bold w-full lg:w-auto text-center">Insumos sumados</a>
                        </button>}
                </div>
