      ...
      <Layout>
        ...
        <div className="flex justify-between">
          <Link href="/listados/insumos/nuevoinsumo">
            <a className="bg-blue-800 py-2 px-5 mt-3 mr-5 inline-block text-white rounded text-sm hover:bg-gray-800 mb-3 uppercase font-bold w-full lg:w-auto text-center">Nuevo Insumo</a>
          </Link>
