...
const NuevoRegistroGE = () => {
  ...
  const terminarProduccion = async (valores) => {
    ...
    const { cantDescarte, cantGuardada, descCajas, observaciones, auxiliar } =
      valores;
  ...
  const handleInicio = async () => {
    try {
      ...
      setRegistro({
        ...registro,
        creado: data.nuevoRegistroGE.creado,
        id: data.nuevoRegistroGE.id,
      });
      setSession(true);
    } catch (error) {
      console.log(error);
              ...
              <div className="bg-white shadow-md px-8 pt-6 pb-8 mb-4">
                ...
                <Select
                  ...
                  getOptionLabel={(opciones) =>
                    `${opciones.lote} ${opciones.producto} Disp: ${opciones.cantidad}`
                  }
                  placeholder="Lote..."
          ...
          <div className="flex justify-center mt-5">
            <div className="w-full bg-white shadow-md px-8 pt-6 pb-8 mb-4 max-w-lg">
              ...
              <div className="flex justify-center mt-1 ">
                <p className="text-gray-700 text-xl font-bold mr-1">
                  Esponjas disponibles:{" "}
                </p>
                <p className="text-gray-700 text-xl font-light px-2">
                  {registro.cantidad}
                </p>
              </div>
              <form
              ...
              >
                ...
                {formikCierre.touched.cantGuardada &&
                formikCierre.errors.cantGuardada ? (
                ...
                {formikCierre.touched.cantDescarte &&
                formikCierre.errors.cantDescarte ? (
                  <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4">
                    <p className="font-bold">Error</p>
                ...
                {formikCierre.touched.descCajas &&
                formikCierre.errors.descCajas ? (
                  <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4">
                    <p className="font-bold">Error</p>
                ...
                {formikCierre.touched.auxiliar &&
                formikCierre.errors.auxiliar ? (
                  <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4">
                    <p className="font-bold">Error</p>
                ...
                {formikCierre.touched.observaciones &&
                formikCierre.errors.observaciones ? (
                  <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4">
                    <p className="font-bold">Error</p>
